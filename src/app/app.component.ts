...
export class AppComponent {
  ...
  imageUrl: any = 'https://i.pinimg.com/originals/00/2d/be/002dbe72e23a2435492ae7cc616511be.jpg';
  ...
  removeUploadedFile() {
    ...
    this.imageUrl = 'https://i.pinimg.com/originals/00/2d/be/002dbe72e23a2435492ae7cc616511be.jpg';
    this.editFile = true;
  ...
  onSubmit() {
    ...
    if(!this.registrationForm.valid) {
      alert('Por favor llene los campos siguintes para crear a su Superhéroe')
      return false;
    } else {
